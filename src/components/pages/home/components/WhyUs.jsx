                ...
                <div className="row g-0">
                  ...
                  <div className="col-sm-6 wow fadeIn" data-wow-delay="0.1s">
                    <div className="text-center bg-primary py-5 px-4 h-100">
                      ...
                      <h1 className="display-5 mb-0">500</h1>
                  ...
                  <div className="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                    <div className="text-center bg-secondary py-5 px-4 h-100">
                      ...
                      <h1 className="display-5 text-white mb-0">70</h1>
                  ...
                  <div className="col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                    <div className="text-center bg-secondary py-5 px-4 h-100">
                      ...
                      <h1 className="display-5 text-white mb-0">3000</h1>
                  ...
                  <div className="col-sm-6 wow fadeIn" data-wow-delay="0.7s">
                    <div className="text-center bg-primary py-5 px-4 h-100">
                      ...
                      <h1 className="display-5 mb-0">7000</h1>
